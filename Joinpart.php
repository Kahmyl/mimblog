	...
	<center >
		...
		<div class="container">
			<div class="card" style="box-shadow: 0 8px 12px 0 rgba(0,0,0,0.2);">
				...
				<h5>Become a partner and be able to post on this website and also advertise at comfortable prices. Click continue to input your details, choose your desired subscription and become a partner.</h5><br><br>
				<button class="btn btn-info"><a href="firenze.php" style="color: white; text-decoration: none;"> Continue</a></button><br><br>
				</div>
			</div>
			</div>
			</div>
