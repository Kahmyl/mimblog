...
<div class= "boggart"> 
  <div class="" style =" border-bottom: solid; border-color: lightgrey; color:white; font-size: 300%; font-family:arial; background-image: url('http://localhost/Blog/entertain.jpg'); background-size: 20rem ;">
            <div style=" margin-left: 0px;">Entertainment</div></div><br><br>
<div class="row">
    <div class="col-sm"><div class="card" style="width: 18rem;">
      <img src="http://localhost/Blog/justin.jpg" class="card-img-top" alt="">
      <div class="card-body">
      <h5 class="card-title">Leonardo DiCaprio, Justin Bieber join All In Challenge for COVID-19 relief</h5>
      <p class="card-text">Some of Hollywood’s biggest names, from singer Justin Bieber to A-list Oscar-winning actor Leonardo DiCaprio, are banding together to help strengthen novel coronavirus relief funds.</p>
       <a href="justin.php" class="btn btn-primary">Read more</a>
    </div>
    </div></div>
    
     <div class="col-sm"><div class="card" style="width: 18rem;"><img src="http://localhost/Blog/mcartney.jpg" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">Paul McCartney to Howard Stern: Chinese wet markets should be shut down</h5>
      <p class="card-text">Paul McCartney called into The Howard Stern Show on Tuesday to speak not only about how he was coping with being in quarantine during the ongoing COVID-19 pandemic, </p>
       <a href="mcartney.php" class="btn btn-primary">Read more</a>
    </div></div></div>


      <div class="col-sm"><div class="card" style="width: 18rem;">
        <img src="http://localhost/Blog/hipster.jpg" class="card-img-top" alt="...">
      <div class="card-body">
      <h5 class="card-title">Jimmy Webb, NYC punk rock style icon, dead at 62</h5>
      <p class="card-text">American punk icon Jimmy Webb died on Tuesday after a battle with cancer. He was 62.

The New York City-based businessman was best known as the manager and buyer of Trash and Vaudeville — the iconic, Manhattan-based rock </p>
 <a href="hipster.php" class="btn btn-primary">Read more</a></div>
...
$query = "
 ...
 foreach ($result as $row) {
  ...
  $query = "
 SELECT * FROM post WHERE category = 2 ORDER BY created_at ASC
 ";
...
<a href="" style="color: lightgrey; text-decoration: none;"><div style="border-width: 10em; max-width: 55rem; margin-left: auto; margin-right: auto; background-image: url('http://localhost/Blog/entertain.jpg'); background-size: 10rem ; border-radius: 3px;"><h2 style="text-align: center;">Load more...</h2></div></a><br><br><br><br><br><br>
