        ...
        if(isset($_FILES['image']))
        {
            ...
            if(in_array($img_ext, $extensions) === true)
            {
                ...
                if(in_array($img_type, $types) === true)
                {
                    ...
                    {
                        $insert_stmt = $pdo->prepare("INSERT INTO post (title, body, category, user_id, image) VALUES( :title, :body, :category, :user_id, :image)");
                        if ($insert_stmt->execute(array(":title"=>$title, ":body"=>$body,  ":category"=>$category, ":user_id"=>$into, ":image"=>$new_img_name))) 
                        {
            ...
            <div class="card" >
                ...
                <div class="card-body">
                    ...
                    ?>  
                        ...
                        <div class="form-group" >
                            <textarea name="body" id="body" cols="100" rows="10" class="form-control" placeholder="Description"></textarea>
                        </div>
                        <div class="form-group">
