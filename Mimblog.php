    ...
    <div class="first">
        <img src="" ></div><br>
         ...
         <div class="" style =" border-bottom: solid; border-color: lightgrey; background:grey; color:white; font-size: 300%; font-family:arial;">
            <div style=" margin-left: 20px;">The Blob</div></div>
         </div><br><br>
          <div class="row">
    <div class="col-sm"><div class="card" style="width: 18rem;">
  <img src="https://techcrunch.com/wp-content/uploads/2020/03/cepheid-genexpert.jpg?w=430&h=230&crop=1" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">A new type of COVID-19 test now approved for use could help with frontline diagnostics</h5>
    <p class="card-text">The U.S. Food and Drug Administration (FDA) is moving much more quickly to grant special ’emergency use authorization’ to equipment and tests that could help increase testing for the novel coronavirus in the U.S., which lags behind most countries in the world when it comes to tests conducted relative to the size of its population. One type of test just approved for use could help expand the availability of frontline testing in hospitals and at clinics where patients are receiving care – without requiring round-tripping to a dedicated diagnostics lab.Cepheid’s COVID-19 test, which the agency approved this week, </p>
    <a href="uscovid.php" class="btn btn-primary">Read more</a>
  </div>

</div></div>
    <div class="col-sm"><div class="card" style="width: 18rem;">
  <img src="https://techcrunch.com/wp-content/uploads/2020/03/unnamed.jpg?w=1390&crop=1" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">YC startup Felix wants to replace antibiotics with programmable viruses</h5>
    <p class="card-text">Right now the world is at war. But this is no ordinary war. It’s a fight with an organism so small we can only detect it through use of a microscope — and if we don’t stop it, it could kill millions of us in the next several decades. No, I’m not talking about COVID-19, though that organism is the one on everyone’s mind right now. I’m talking about antibiotic-resistant bacteria.
...
You see, more than 700,000 people died globally from bacterial infections last year — 35,000 of them in the U.S. If we do nothing, that number could grow to 10 million annually by 2050, according to a United Nations report.
    ...
    <a href="ycvirus.php" class="btn btn-primary">Read more</a>
  </div>
    </div></div>
    <br><div class="col-sm"> <div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title">India launches WhatsApp chatbot to create awareness about coronavirus, asks social media services to curb spread of misinformation


</h5>

    <a href="indiachat.php" class="card-link">Read</a>

  </div>
</div><br>
        <div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title">Twitter prioritizes blue-check verifications to confirm experts on COVID-19 and the novel coronavirus</h5>

    <a href="twitter.php" class="card-link">Read</a>

  </div>
</div><br>
        <div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title">Under quarantine, media is actually social</h5>

    <a href="medsoc.php" class="card-link">Read</a>

  </div>
</div><br>
        <div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title">Netflix decides to pickup “The Lovebirds,” an upcoming romantic comedy starring Kumail Nanjiani and Issa Rae.</h5>


    <a href="lovebirds.php" class="card-link">Read</a>
...
<div class="boggart">
    <div class="vold" style="border-color: lightgrey; font-size: 300%;
  font-family:arial; background: grey; color:white;" ><div style="margin-left: 10px;">Updates</div></div> <br> <br>
  <?php
 ...
 foreach ($result as $row) {
  ...
  $query = "
 SELECT * FROM post WHERE category = 1 ORDER BY created_at ASC
 ";
